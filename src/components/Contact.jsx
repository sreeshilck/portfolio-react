...
function Contact() {
  return (
    <div className='w-full h-screen bg-black  flex justify-center md:items-center p-4 '>
        <form action="https://getform.io/f/6b876ff1-1a0f-4f32-aa89-5af66e32a744" method='POST' className='flex flex-col w-full max-w-[600px]'>
            ...
            <button className='text-white border-2 hover:bg-blue-500 hover:border-blue-500 py-3 px-4 my-8 mx-auto flex items-center'>Submit</button>
